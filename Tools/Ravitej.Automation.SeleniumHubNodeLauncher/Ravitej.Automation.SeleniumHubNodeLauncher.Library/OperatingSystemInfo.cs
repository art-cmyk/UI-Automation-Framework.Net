...
//    Console.WriteLine( "----------------------------" );
//    Console.WriteLine( "Name = {0}", OperatingSystemInfo.Name );
//    Console.WriteLine( "Edition = {0}", OperatingSystemInfo.Edition );
//    Console.WriteLine( "Service Pack = {0}", OperatingSystemInfo.ServicePack );
//    Console.WriteLine( "Version = {0}", OperatingSystemInfo.VersionString );
//    Console.WriteLine( "Bits = {0}", OperatingSystemInfo.Bits );

//alternate method returns Microsoft Windows 7 Enterprise etc.
...
namespace Ravitej.Automation.SeleniumHubNodeLauncher.Library
{
    ...
    public static class OperatingSystemInfo
    {
        ...
        #region PRODUCT NAME
        static private string s_ProductName;
        /// <summary>
        /// Gets the name of the operating system running on this computer from the Product Name registry key
        /// </summary>
        static public string ProductName
        {
            get
            {
                if (s_ProductName != null)
                    return s_ProductName; //***** RETURN *****//

                string productName = "unknown";

                productName = RegistryRead(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion",
                    "ProductName", "");
